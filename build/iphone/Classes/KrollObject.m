...
//@interface SaratogaCRMObject : NSObject
//@end

@interface SaratogaCRMObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SaratogaCRMObject class]])
		{
			for (NSString *key in [[(SaratogaCRMObject*)o modules] allKeys])
			{
