...
// in simulator we redefine to format for SaratogaCRM Developer console
...
{\
	NSString * exceptionName = [@"org.saratogacrm." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.saratogacrm";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISaratogaCRMNativeItemNone = -1, 
	UISaratogaCRMNativeItemSpinner = -2,
	UISaratogaCRMNativeItemProgressBar = -3,
	
	UISaratogaCRMNativeItemSlider = -4,
	UISaratogaCRMNativeItemSwitch = -5,
	UISaratogaCRMNativeItemMultiButton = -6,
	UISaratogaCRMNativeItemSegmented = -7,
	
	UISaratogaCRMNativeItemTextView = -8,
	UISaratogaCRMNativeItemTextField = -9,
	UISaratogaCRMNativeItemSearchBar = -10,
	
	UISaratogaCRMNativeItemPicker = -11,
	UISaratogaCRMNativeItemDatePicker = -12,
	
	UISaratogaCRMNativeItemInfoLight = -13,
	UISaratogaCRMNativeItemInfoDark = -14,
	
	UISaratogaCRMNativeItemDisclosure = -15,
	
	UISaratogaCRMNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SaratogaCRM instances of
