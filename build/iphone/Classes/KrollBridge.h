...
@interface SaratogaCRMObject : KrollCoverageObject {
#else
@interface SaratogaCRMObject : KrollObject {
#endif
@private
...
extern NSString * SaratogaCRM$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SaratogaCRMObject *_saratogacrm;
    KrollObject* console;
	BOOL shutdown;
