...
/**
 Base class for all SaratogaCRM views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SaratogaCRM view hierarchy (such as wrapped iOS UIViews) was touched.
